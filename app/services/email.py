...
class ResendEmailService:
    ...
    def _get_welcome_email_html(user_name: str) -> str:
        """Gmail Android compatible welcome email."""
        return """<!DOCTYPE html>
...
<img src="https://res.cloudinary.com/lh7xcjvh/image/upload/f_auto,q_auto/ChatGPT_Image_Jul_6_2026_03_22_00_AM_qkzxxu.png" width="600" height="auto" alt="SoulConnect" style="width: 600px; height: auto; display: block; margin: 0; padding: 0; border: 0; outline: 0; text-decoration: none; max-width: 100%;">
</td>
</tr>
<tr>
<td style="width: 600px; padding: 0; height: 4px; background-color: #D4AF37; border: 0;"></td>
</tr>
<tr>
...
<tr>
<td align="center" style="padding: 0;">
<p style="font-size: 40px; line-height: 40px; margin: 0 0 12px 0; text-align: center;">💜</p>
...
<p style="font-size: 16px; font-weight: 600; color: #1a1a1a; margin: 0 0 16px 0; line-height: 1.4; text-align: center; font-family: Arial, Helvetica, sans-serif;">Hi """ + user_name + """! 👋</p>
...
<tr>
<td style="padding: 24px 24px 32px 24px; width: 600px;">
...
<tr>
<td style="padding: 24px; text-align: center; width: 600px;">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
<tr>
<td bgcolor="#4B2E83" style="background-color: #4B2E83; padding: 12px 32px; text-align: center;">
<a href="https://soulconnect.health" style="color: #ffffff; text-decoration: none; font-weight: 600; font-size: 15px; font-family: Arial, Helvetica, sans-serif; display: block; line-height: 1.2;">Visit SoulConnect</a>
</td>
</tr>
</table>
</td>
...
<p style="font-size: 24px; line-height: 24px; margin: 12px 0; text-align: center;">💜</p>
...
<p style="margin: 0 0 20px 0; border-bottom: 1px solid #e5e5e5; padding-bottom: 15px; color: #1a1a1a; font-family: Arial, Helvetica, sans-serif;">{user_email}</p>

{f'<p style="margin: 0 0 10px 0; color: #7C3AED; font-weight: 600; font-size: 12px; text-transform: uppercase; font-family: Arial, Helvetica, sans-serif;">Name</p><p style="margin: 0 0 20px 0; border-bottom: 1px solid #e5e5e5; padding-bottom: 15px; color: #1a1a1a; font-family: Arial, Helvetica, sans-serif;">{user_name}</p>' if user_name else ''}

{f'<p style="margin: 0 0 10px 0; color: #7C3AED; font-weight: 600; font-size: 12px; text-transform: uppercase; font-family: Arial, Helvetica, sans-serif;">Struggle</p><p style="margin: 0 0 20px 0; border-bottom: 1px solid #e5e5e5; padding-bottom: 15px; color: #1a1a1a; font-family: Arial, Helvetica, sans-serif;">{struggle}</p>' if struggle else ''}
...
{f'<p style="margin: 0 0 10px 0; color: #7C3AED; font-weight: 600; font-size: 12px; text-transform: uppercase; font-family: Arial, Helvetica, sans-serif;">IP Address</p><p style="margin: 0 0 20px 0; border-bottom: 1px solid #e5e5e5; padding-bottom: 15px; color: #1a1a1a; font-family: Arial, Helvetica, sans-serif; word-break: break-all;">{ip_address}</p>' if ip_address else ''}
</td>
</tr>
